...
return `<div class="pet-card"> <div class="pet-avatar">${pet.avatar}</div> <div> <div class="pet-name">${pet.name}</div> <div class="pet-stats">level ${pet.level} . ${pet.xp} xp</div> <div class="progress"><span style="width:${progress}%"></span></div> </div> </div>`;
})
.join(””);
}